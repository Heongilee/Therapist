...
- `자신이 겪는 인생 문제나 고민 등 다양한 주제에 대해 토론할 수 있는 커뮤니티 기능 (like 네이버 지식인) + WebRTC 기술을 이용한 실시간 P2P 음성 채팅 서비스`   
　   
　   
...
- Deployment : ![AWS RDS_mariaDB](https://img.shields.io/badge/AWS%20RDS_mariaDB-10.4.13-%23232F3E?logo=Amazon%20AWS)
　   
　   
