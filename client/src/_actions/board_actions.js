...
import { BOARD_REQUEST, PAGE_REQUEST, LOADING} from './types';
...
// 게시글 요청
export const requestBoardList = async (postType='category1', page=1) => {

    const request = await temp(postType, page);
    return {
        type: BOARD_REQUEST,
...
// // 페이지 요청
// export const requestPage = async ({posts, page}) => {

//     const request = await pageCal(posts,page);
