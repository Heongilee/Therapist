...
const mypageApi = {
    ...
    fetchMypage: async(postType='category1', page='1',userName=null) => {

        try {
            // const response = await axios.get(`/mypage/${userName}?menuType=${postType}&page=${page}`);
    ...
    fetchMypageDelete: async(data) => {


        try {
            // const response = await axios.post(`/users/mypage`, data);
            const response = true;
